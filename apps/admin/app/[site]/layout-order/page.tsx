...
export default async function LayoutOrderPage({ params }: { params: Promise<{ site: string }> }) {
  ...
  return (
    <div>
      ...
      <div className="mt-3 mb-4 flex items-center gap-2">
        ...
        <h1 className="text-xl font-semibold text-heading">Page layout</h1>
      </div>

      <LayoutEditor siteId={site.id} />
    </div>
  );
}
